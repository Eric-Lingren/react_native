    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.paragraph}>
                    You can estimate how many decks remain by estimating how many cards are in the discard tray. Generally casinos use a 6-deck shoe, but make sure to ask how many decks are being used if you are unsure.
                    By dividing the running count by the number of decks remaining, we determine the true count.
                </Text>
                <Text style={styles.paragraph}>
                    For each true count of 1, the advantage shifts to the player by 0.5%. For example if the true count is +1 you are playing an even game.  If the running count is +8 and there are 2 decks left that puts the true count at +4. This means the player now has a 3.5% advantage over the casino (remember that if we play perfect basic strategy the casino still has a 0.5% advantage.) 
                </Text>
                <Text style={styles.paragraph}>
