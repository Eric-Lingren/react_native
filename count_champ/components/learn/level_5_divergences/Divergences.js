...
class Divergences extends React.Component {
    static navigationOptions = {
        title: 'Learn Divergences',
    };
            ...
            <ScrollView>
                <View style={styles.container}>
                    <Text style={styles.paragraph}>
                        A divergence is an action we take that is standard to the norm.  In blackjack this refers to alterations we make in our basic strategy depending on the true count.
                    </Text>
                    <Text style={styles.paragraph}>
